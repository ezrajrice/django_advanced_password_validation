...
def test_max_consecutive_characters_validator():
    ...
    assert exc.value.message == "Password contains consecutively repeating characters. e.g 'aaa' or '111'"
...
def test_consecutively_increasing_digit_validator():
    ...
    assert exc.value.message == "Password contains consecutively increasing digits. e.g '12345'"
...
def test_consecutively_decreasing_digit_validator():
    ...
    assert exc.value.message == "Password contains consecutively decreasing digits. e.g '54321'"
